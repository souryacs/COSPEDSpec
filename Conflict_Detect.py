...
def Possible_Conflict_Curr_Reln(src_taxa_label, dest_taxa_label, Reachability_Graph_Mat, target_edge_type, Bin_SupTr_Opt):
  ...
  if (src_taxa_clust_idx == dest_taxa_clust_idx):
    return RELN_ALREADY_ESTABLISHED
